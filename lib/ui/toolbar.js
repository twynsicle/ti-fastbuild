	...
	render() {
		...
		switch (this.state.platform) {
			...
			case 'android':
				buildOptions = [
					<option value="run">Run</option>,
					<option value="run-apk-only">Run - apk only</option>,
					<option value="run-no-build">Run - no build</option>,
				];
				break;
			case 'windows':
				buildOptions = [
		...
		if (this.state.buildInProgress) {
			buildButtons = <div className="toolbar-item button build-button-container">
			...
			<div className={this.state.showingCodeSigning || this.state.buildCommand === 'custom' ? 'appc-toolbar toolbar-expanded' : 'appc-toolbar'}>
				<div className="toolbar-row">
					...
					<div className="toolbar-left main-toolbar-group">
						...
						<Select ref="buildSelect" value={this.state.buildCommand} disabled={this.state.disableUI}
					...
					<div className="toolbar-right main-toolbar-group">
						<Button icon="plus" className="button-right" flat="true" disabled={this.state.disableUI} click={this.generateButtonClicked.bind(this)} />
