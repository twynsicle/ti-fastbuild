	...
	render() {
		...
		if (this.state.buildInProgress) {
			...
			buildButtons = <div className="toolbar-item button build-button-container">
				...
				<Button ref="buildButton" className="build-button fast-build" custom="true" icon="light-bulb" disabled={this.state.disableUI} click={this.fastBuildButtonClicked.bind(this)} />
			</div>;
		}
