		...
		if (this.state.buildInProgress) {
			...
			buildButtons = (
				<div className="toolbar-item button build-button-container">
					...
					<Button ref="buildButton" className={fastBuildButtonClass} custom="true" icon="rocket" disabled={this.state.disableUI || platform() === 'darwin'} click={this.fastBuildButtonClicked.bind(this)} />
					<Button ref="buildButton" className="build-button reload" custom="true" icon="repo-sync" disabled={this.state.disableUI || platform() === 'darwin'} click={this.reloadButtonClicked.bind(this)} />
				</div>
			);
		}
