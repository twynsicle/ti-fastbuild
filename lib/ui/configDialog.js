...
export default class ConfigDialog {
	...
	render() {
		return (
			<div className="config-dialog native-key-bindings appc-config" attributes={{ tabindex: '-1' }}>
				...
				{ this.buildCheckboxSetting('enable-files-watcher', SETTINGS.BUILD.ENABLE_FILE_WATCHER, 'Enable File Watcher') }
				<div className="row heading">
					<h2>Debugger</h2>
				</div>
				...
				{ this.buildCheckboxSetting('hide-webview-messages', SETTINGS.CONSOLE.HIDE_WEBVIEW_MESSAGES, 'Hide webview messages') }
				{ this.buildCheckboxSetting('hide-timestamps', SETTINGS.CONSOLE.HIDE_TIMESTAMPS, 'Hide timestamps') }
