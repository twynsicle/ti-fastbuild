...
export default class Console {
	...
	render() {
		return <div className="appc-console">
			...
			<ConsoleLog ref="log" autoScroll={this.state.autoScroll} linewrap={this.state.linewrap}/>
		</div>;
	}
	...
	openDevtools(line) {
		...
		if (matchResult) {
			...
			atom.commands.dispatch(atom.views.getView(atom.workspace), 'appc:browser:show', {
				url: url
			});
		}
	}
